...
//		    datatype: 'json',
		    ...
		    data : [ {
				...
				name : "shanghai ibm",
				code : "13387210",
				salesman : "520011440090",
				contactNameTel : "520011440090",
				contactNameTel : "119372",
			...
			rownumbers: true,
			rownumWidth:50,
			colNames:['id','','客户名称', '客户编号','业务员', '联系人','联系人电话','办公地址','分管业务部','上级单位','所属国别','行业'],
			colModel:[
			    {name:'id',index:'id',width:90,hidden:true},
			    {name:'action',index:'action',width:32},
			    {name:'name',index:'name',width:100},
			    {name:'code',index:'code',width:90,editable:false},
			    {name:'salesman',index:'salesman',width:90,editable:false},
			    {name:'contactName',index:'contactName',width:90,editable:false},
			    {name:'contactNameTel',index:'contactNameTel',width:140,editable:false},
			    ...
			    {name:'所属国别',index:'所属国别',width:140,editable:false},
			    {name:'行业',index:'行业',width:140,editable:false}
			], 
			viewrecords : false,
			rowNum:10,
			rowList:[10,20,30],
					...
					success:function(json){
						if(json.status == "success"){
							$('#user-input').load('../common/success.jsp',
									{msg:'操作已成功，客户"<b>'+$('#username').val()+'"</b>保存成功',
									 seconds:'3000',
									 tips:''},'');
