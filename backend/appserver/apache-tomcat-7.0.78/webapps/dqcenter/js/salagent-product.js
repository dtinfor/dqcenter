...
//			供应商名称、产品名称、产品价格、有效期、是否追溯、产品支付方式
			colNames:['id','','供应商名称', '产品名称','产品价格', '类型', '有效期','是否追溯','产品支付方式'],
			colModel:[
			    {name:'id',index:'id',width:90,hidden:true},
			    {name:'action',index:'action',width:16},
			    {name:'name',index:'name',width:100,editable:true},
			    {name:'产品名称',index:'产品名称',width:90,editable:false},
			    {name:'产品价格',index:'产品价格',width:90,editable:false},
			    {name:'type',index:'type',width:90,editable:false},
			    {name:'有效期',index:'有效期',width:90,editable:false},
			    {name:'是否追溯',index:'是否追溯',width:90,editable:false},
			    {name:'产品支付方式',index:'产品支付方式',width:140,editable:false}
			], 
			viewrecords : false,
			rowNum:10,
			rowList:[10,20,30],
